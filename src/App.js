...
const PixPage = () => {
  ...
  return (
    // O container principal da PixPage agora é max-w-md novamente para afunilar
    <div className="flex flex-col items-center p-6 bg-[#F4F6F8] max-w-md mx-auto">
...
const App = () => {
  ...
  return (
    // Adicionado pt-6 ao container principal para um pequeno espaçamento no topo
